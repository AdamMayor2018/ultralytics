...
launcher = 'none'
load_from = 'work_dirs/yolov5_s-v61_fast_1xb12-40e_cat_et1_data_detection/best_coco_bbox_mAP_epoch_39.pth'
log_level = 'INFO'
...
train_cfg = dict(max_epochs=40, type='EpochBasedTrainLoop', val_interval=20)
...
weight_decay = 0.0005
widen_factor = 0.5
work_dir = './work_dirs/yolov5_s-v61_fast_1xb12-40e_cat_et1_data_detection'
