...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', default='yolo8_merge_with_column_dfpn_v9', type=str,
    ...
    model = YOLO("/data/cx/aigc/stable-diffusion-webui/runs/detect/yolo8_merge_with_column_dfpn_v9/weights/best.pt".format(args.exp_name))
