...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', default='train_v8s_baseline', type=str,
    ...
    model = YOLO("/data/cx/aigc/stable-diffusion-webui/runs/detect/yolo8_DFPN_column/weights/best.pt".format(args.exp_name))
